...
const Shop = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Shop Fresh | Electro Kart</title>
            </Helmet>
                ...
                <div className={styles.product__container}>
                    ...
                    {(filter === "processing" || filter === "idle")
                        ...
                        : filteredProducts.map((product, i) => {
                            ...
                            return <RenderProduct key={product._id} product={product} isWislisted={isWislisted} isAdd={isAdd} handlewishlistToggle={wishlistToggle} handleaddToBasket={addToBasket} />
                        })
                    }
                </div>
            </section>
